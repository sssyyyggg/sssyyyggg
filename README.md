<div align= "center">
    ...
    <div style="font-weight: 700; font-size: 15px; text-align: left; color: #282d33;"> 신뢰 가능한 서비스를 위해 데이터 정합성을 확보하고, 최신 AI 기술을 효율적으로 시스템에 연결하는 데 집중합니다.<br>사용자의 요구를 기술적 솔루션으로 풀어내기 위해 성장하고 있습니다. </div> 
    </div>
    <div style="text-align: left;">
